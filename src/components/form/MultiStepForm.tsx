...
interface MultiStepFormContextType<T extends z.ZodType<any, any, any>> {
  methods: UseFormReturn<z.output<T>>;
  currentStep: number;
  totalSteps: number;
  nextStep: () => void;
  prevStep: () => void;
...
export const useMultiStepForm = <T extends z.ZodType<any, any, any>>() => {
...
interface MultiStepFormProps<T extends z.ZodType<any, any, any>>
  extends Omit<ComponentProps<"form">, "onSubmit"> {
  children: ReactNode;
  validationSchema: T;
  defaultValues?: z.output<T>;
  onSubmit: (values: z.output<T>) => void | Promise<void>;
  formOptions?: UseFormProps<z.output<T>>;
  setFormMethod?: Dispatch<SetStateAction<UseFormReturn<z.output<T>, any, z.output<T>> | null>>;
}
 ...
 * </MultiStepForm>
 */
export const MultiStepForm = <T extends z.ZodType<any, any, any>>({
  children,
  validationSchema,
  defaultValues,
  onSubmit,
  ...
  const methods = useForm<z.output<T>>({
